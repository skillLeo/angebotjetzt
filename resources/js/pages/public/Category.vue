    ...
    <section class="bg-sand-100 px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        <div class="mx-auto max-w-7xl">
            ...
            <p class="text-lead mt-6 max-w-2xl text-ink-700">
                {{ `${inspectorCount} geprüfte Gutachter stehen bundesweit bereit, um Ihnen ein individuelles Angebot zu machen. Wählen Sie das benötigte Gutachten, beschreiben Sie Ihr Fahrzeug und Ihre Region.` }}
            </p>
            <Link
                href="/request"
