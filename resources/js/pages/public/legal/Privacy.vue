...
<template>
    <LegalPage :title="'Datenschutzerklärung'" :updated="'Juli 2026'">
        ...
        <p>{{ 'Im Rahmen einer Anfrage erheben wir die von Ihnen angegebenen Fahrzeug-, Kontakt- und Standortdaten (Name, E-Mail, Telefon, PLZ, Ort). Diese Daten werden ausschließlich zur Vermittlung passender Gutachter und zur Abwicklung Ihres Auftrags verwendet.' }}</p>
        ...
        <p>
            ...
            <a href="/cookie-policy">{{ 'Cookie-Richtlinie' }}</a>{{ '. Nicht notwendige Cookies werden nur mit Ihrer Einwilligung gesetzt.' }}
        </p>
    </LegalPage>
</template>
