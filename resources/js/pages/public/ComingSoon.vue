    ...
    <section class="flex min-h-[70vh] items-center bg-sand-100 px-4 py-20 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-2xl text-center">
            ...
            <p class="text-lead mx-auto mt-5 max-w-lg text-ink-700">
                {{ `Diese Kategorie ist bald verfügbar. Lassen Sie sich benachrichtigen, sobald ${category.name} auf AngebotJetzt startet – und sichern Sie sich die ersten Angebote.` }}
            </p>
