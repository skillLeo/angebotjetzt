...
<template>
    ...
    >
        <h1 class="font-display text-3xl font-extrabold text-navy-700">Als Gutachter registrieren</h1>
        <p class="mt-2 text-ink-500">Erhalten Sie passende Anfragen aus Ihrer Region automatisch.</p>
        ...
        <form class="mt-8 space-y-4" @submit.prevent="submit">
            ...
            <label class="flex items-start gap-3 text-sm text-ink-700">
                ...
                <span>Ich akzeptiere die <Link href="/agb" class="font-semibold text-green-600 underline" target="_blank">AGB</Link> und <Link href="/datenschutz" class="font-semibold text-green-600 underline" target="_blank">Datenschutzerklärung</Link>.</span>
            </label>
            ...
            <p class="text-center text-sm text-ink-500">
                Bereits registriert? <Link href="/gutachter/login" class="font-semibold text-green-600">Zum Login</Link>
            </p>
        </form>
    </SplitAuthShell>
</template>
