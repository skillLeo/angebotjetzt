...
<template>
    <Head><title>{{ 'Zahlung erfolgreich' }}</title></Head>
    ...
    <div class="mx-auto max-w-xl py-10 text-center">
        ...
        <h1 class="font-display mt-8 text-3xl font-extrabold text-navy-700">{{ 'Zahlung erfolgreich!' }}</h1>
        <p class="mt-3 text-ink-500">
            {{ 'Vielen Dank. Ihr Auftrag ist verbindlich bestätigt und der Gutachter wurde benachrichtigt. Sie erhalten in Kürze eine Bestätigung per E-Mail.' }}
        </p>
