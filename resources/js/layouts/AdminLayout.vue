...
const nav = computed(() => [
    ...
    { label: 'Startseite', href: '/admin/homepage-content', icon: LayoutTemplate, active: url.value.startsWith('/admin/homepage-content') },
    { label: 'Rechtliche Seiten', href: '/admin/legal-content', icon: Scale, active: url.value.startsWith('/admin/legal-content') },
